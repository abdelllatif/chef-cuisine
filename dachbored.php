    ...
    <div class="flex flex-wrap min-h-screen">
        ...
        <aside class="bg-white w-full md:w-1/4 shadow rounded-lg p-4">
            ...
            <div id="partiegestionDash" class="flex flex-col gap-4 w-full bg-gray-200 p-4 rounded">
                <button onclick="openSection('chefDashboard')" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
                    Gestion des Réservations
                </button>
                <button onclick="openSection('addMenu')" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
                    Ajouter menu
                </button>
                <button onclick="openSection('addPlate')" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
                    Ajouter plat
                </button>
                <button onclick="openSection('viewClients')" class="bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
                    Voir tous les clients
                </button>
                <button onclick="openSection('acceptedRequests')" class="bg-blue-500 text-white p-2 rounded hover:bg-green-600">
                   clents Demande 
                </button>
                <button onclick="openSection('editMenu')" class="bg-blue-500 text-white p-2 rounded hover:bg-purple-600">
                    Modifier menu
                </button>
            </div>
        </aside>
        ...
        <main class="flex-1 p-6">
            <div id="chefDashboard" class="dashboard-section active">
                ...
                <!-- Details du Prochain Client -->
                <div class="bg-white p-6 rounded-lg shadow-lg mb-8">
                    <h3 class="text-2xl font-bold mb-4 text-gray-700">Prochain Client</h3>
    ...
    <section class="bg-white p-8 rounded-lg shadow-lg mb-6 max-w-2xl mx-auto">
        ...
        <form action="checkaddmenu.php" method="POST" class="space-y-6">
            ...
            <div class="flex justify-center">
                <button type="button" id="addPlatsButton" class="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-all focus:outline-none focus:ring-2 focus:ring-green-500">
                    Add Another Plat
                </button>
            </div>
            ...
            <div id="addPlate" class="dashboard-section">
                ...
                <form action="process_plat.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                    <!-- Plat Title -->
                    <div class="flex flex-col">
...
<!-- Buttons to Show Client Sections -->
<div class="flex justify-center space-x-4 mb-6">
    <button id="demandsButton" class="bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700 transition-all">
        Voir les Demandes
    </button>
    <button id="acceptedButton" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-all">
        Clients Acceptés
    </button>
    <button id="rejectedButton" class="bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700 transition-all">
        Clients Refusés
    </button>
</div>

<!-- Clients Demands Section -->
<div id="clientsDemands" class="clients-section hidden">
    ...
    <table class="min-w-full table-auto border-collapse">
        ...
        <tbody>
            <!-- Sample Row (You can dynamically add rows using PHP or JS) -->
            <tr>
...
<div id="clientsRejected" class="clients-section hidden">
    ...
    // Get all dropdowns in platsContainer
    const allDropdowns = platsContainer.querySelectorAll('select');

    // Check if any of the dropdowns has no value selected
    for (let dropdown of allDropdowns) {
        if (dropdown.value === "") {
            alert("Please select a plat before adding another.");
            return; // Stop execution if any dropdown has no value
        }
    }

    // Create a new plat dropdown container
    ...
    // Append dropdown and button to the div
